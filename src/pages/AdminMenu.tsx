...
import { collection, doc, getDoc, setDoc, query, orderBy, getDocs, onSnapshot } from "firebase/firestore";
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setAlert({
        show: true,
        title: "त्रुटि!",
        message: err instanceof Error ? err.message : "मेनु सुरक्षित गर्दा त्रुटि भयो।",
        type: 'error'
      });
    } finally {
      setSaving(false);
        ...
        <div className="p-8 max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm mb-8">
            <h3 className="text-lg font-black text-slate-900 mb-6 flex items-center gap-2">
              <Plus size={20} className="text-primary" /> नयाँ मेनु वस्तु थप्नुहोस्
            </h3>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
              <input
                type="text"
                placeholder="मेनु वस्तुको नाम"
                value={newItem.label}
              ...
              >
                ...
                <option value="category">विधा</option>
                <option value="custom">अनुकूलित URL</option>
              </select>
          ...
          <div className="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm">
            <h3 className="text-lg font-black text-slate-900 mb-6">मेनु वस्तुहरू ({menu?.items.length || 0})</h3>
            ...
            {menu && menu.items.length > 0 ? (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-slate-500 mt-1">
                          {item.type === "category"
                            ? `विधा: ${categories.find(c => c.slug === item.categoryId)?.nameNepali || "पनि छैन"}`
                            : item.type === "custom"
                            ? `लिङ्क: ${item.url}`
                            : "सामान्य लिङ्क"}
                        </p>
                      ...
                      <button
                        ...
                        title={item.isVisible ? "लुकाउनुहोस्" : "देखाउनुहोस्"}
                      >
              ...
              <div className="text-center py-12 text-slate-400">
                ...
                <p className="font-medium">कुनै मेनु वस्तु छैन। माथि नयाँ वस्तु थप्नुहोस्।</p>
              </div>
            )}
          </div>
          ...
          <div className="mt-8 p-6 bg-blue-50 rounded-2xl border border-blue-200 text-sm text-blue-800 flex items-start gap-3">
            ...
            <div>
              <p className="font-bold mb-2">मेनु संपादन गाइड:</p>
              <ul className="space-y-1 text-xs">
                <li>• <strong>ड्र्याग गरेर पुनः क्रमबद्ध गर्नुहोस्</strong> - वस्तुहरूलाई पुनः क्रमबद्ध गर्न ड्र्याग ह्यान्डल प्रयोग गर्नुहोस्</li>
                <li>• <strong>दिने/लुकाउने बटन</strong> - आँखाको प्रतीकमा क्लिक गरेर मेनु वस्तु देखाउनु वा लुकाउनु</li>
                <li>• <strong>सुरक्षित गर्नुहोस् बटन</strong> - परिवर्तनहरू सुरक्षित गर्न सुरक्षित गर्नुहोस् बटन क्लिक गर्नुहोस्। हेडरमा तुरुन्त देखा पर्नेछ।</li>
              </ul>
            </div>
          </div>
        </div>
